...
| `record-facts.md` | Phase 1 done; Phase 2 open | After a match: every fact the record supports is decidable, one decision accepts the record's facts, and the record's more exact value can become the tree's. |
